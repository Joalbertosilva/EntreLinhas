  ...
  if (variant === 'rail') {
    return (
      <svg
        ...
        aria-hidden
      >
        <rect width="480" height="2" fill="#003366" />
        <path
          fill="#003366"
          d="M-8 2 C64 8, 128 0, 192 6 C256 12, 320 2, 384 8 C432 12, 464 4, 488 6 L488 12 C464 10, 432 14, 384 12 C320 8, 256 14, 192 10 C128 6, 64 12, -8 8 Z"
        />
        <path
          fill="#0066cc"
          d="M-8 10 C72 16, 136 6, 208 12 C280 18, 344 8, 416 14 C448 16, 472 10, 488 12 L488 18 C472 16, 448 20, 416 18 C344 12, 280 20, 208 16 C136 12, 72 18, -8 14 Z"
        />
        <path
          fill="#efb034"
          d="M-8 18 C80 24, 152 14, 224 20 C296 26, 368 16, 488 22 L488 28 L-8 28 Z"
        />
      </svg>
    )
  }
